...
class wallet_api
{
   public:
     ...
     bool is_public_key_registered(string public_key) const;
      ...
      /** Imports accounts from a columbu 0.x wallet file.
       * Current wallet file must be unlocked to perform the import.
       *
       * @param filename the columbu 0.x wallet file to import
       * @param password the password to encrypt the columbu 0.x wallet file
      ...
      /** Imports from a columbu 0.x wallet file, find keys that were bound to a given account name on the
       * columbu 0.x chain, rebind them to an account name on the 2.0 chain.
       * Current wallet file must be unlocked to perform the import.
       *
       * @param filename the columbu 0.x wallet file to import
       * @param password the password to encrypt the columbu 0.x wallet file
       * @param src_account_name name of the account on columbu 0.x chain
       * @param dest_account_name name of the account on columbu 2.0 chain,
